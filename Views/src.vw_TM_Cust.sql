...
SELECT [acct_id]
      ...
      ,[acct_rep_name]
      ,[priority]
		, ISNULL(TRY_CAST([points] AS decimal(18,6)),0) [points]
		, ISNULL(TRY_CAST([points_ytd] AS decimal(18,6)),0) [points_ytd]
		, ISNULL(TRY_CAST([points_itd] AS decimal(18,6)),0) [points_itd]
