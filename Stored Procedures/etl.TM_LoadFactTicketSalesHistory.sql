...
CREATE PROCEDURE [etl].[TM_LoadFactTicketSalesHistory]
(
	@BatchId INT = 0,
...
MERGE dbo.FactTicketSalesHistory AS mytarget
...
WHEN MATCHED AND 1=0 AND isnull(mySource.DeltaHashKey,-1) <> isnull(myTarget.DeltaHashKey, -1)
THEN UPDATE SET 
