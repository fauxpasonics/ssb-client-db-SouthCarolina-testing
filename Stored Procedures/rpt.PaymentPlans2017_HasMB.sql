...
CREATE PROCEDURE [rpt].[PaymentPlans2017_HasMB]
AS
...
JOIN dbo.vwDimCustomer_ModAcctId b ON a.acct_id = b.AccountId AND b.SourceSystem = 'TM' AND b.CustomerType = 'Primary'
