CREATE TABLE [etl].[tmp_load_325357CCF77A4437A3630EB98671C90A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_325357CCF77A4437A3630EB98671C90A_ss] ON [etl].[tmp_load_325357CCF77A4437A3630EB98671C90A] ([SourceSystem], [SSID])
GO
