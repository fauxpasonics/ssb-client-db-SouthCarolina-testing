CREATE TABLE [etl].[tmp_load_ADDAEF24C63D46ECB6F7F2040454237E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ADDAEF24C63D46ECB6F7F2040454237E_ss] ON [etl].[tmp_load_ADDAEF24C63D46ECB6F7F2040454237E] ([SourceSystem], [SSID])
GO
