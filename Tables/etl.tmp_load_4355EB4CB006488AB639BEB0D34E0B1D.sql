CREATE TABLE [etl].[tmp_load_4355EB4CB006488AB639BEB0D34E0B1D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4355EB4CB006488AB639BEB0D34E0B1D_ss] ON [etl].[tmp_load_4355EB4CB006488AB639BEB0D34E0B1D] ([SourceSystem], [SSID])
GO
