CREATE TABLE [etl].[tmp_load_30BDF93958E14B8E9B6B61FD444C85D2]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_30BDF93958E14B8E9B6B61FD444C85D2_ss] ON [etl].[tmp_load_30BDF93958E14B8E9B6B61FD444C85D2] ([SourceSystem], [SSID])
GO
