CREATE TABLE [etl].[tmp_load_33C46AA150A54FB48C4EA04A2FB2A03B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_33C46AA150A54FB48C4EA04A2FB2A03B_ss] ON [etl].[tmp_load_33C46AA150A54FB48C4EA04A2FB2A03B] ([SourceSystem], [SSID])
GO
