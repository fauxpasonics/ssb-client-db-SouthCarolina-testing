CREATE TABLE [etl].[tmp_load_793CC72186AC432B84E0BEB6C4693C96]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_793CC72186AC432B84E0BEB6C4693C96_ss] ON [etl].[tmp_load_793CC72186AC432B84E0BEB6C4693C96] ([SourceSystem], [SSID])
GO
