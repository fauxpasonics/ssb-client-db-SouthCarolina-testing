CREATE TABLE [etl].[tmp_load_ADC15066035B4A069C6B04AAED5C1403]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ADC15066035B4A069C6B04AAED5C1403_ss] ON [etl].[tmp_load_ADC15066035B4A069C6B04AAED5C1403] ([SourceSystem], [SSID])
GO
