CREATE TABLE [etl].[tmp_load_D14DC1B426FE44A2812B94E520A4B1F6]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D14DC1B426FE44A2812B94E520A4B1F6_ss] ON [etl].[tmp_load_D14DC1B426FE44A2812B94E520A4B1F6] ([SourceSystem], [SSID])
GO
