CREATE TABLE [zzz].[archive__TM_Solicit_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Creat__1209AD79] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Solicit_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Solicit] ON [zzz].[archive__TM_Solicit_20170516] ([solicitation_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Solicit_20170516] ([SourceFileName])
GO
