CREATE TABLE [etl].[tmp_load_0A22426571184DF59A52533340083FA9]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0A22426571184DF59A52533340083FA9_ss] ON [etl].[tmp_load_0A22426571184DF59A52533340083FA9] ([SourceSystem], [SSID])
GO
