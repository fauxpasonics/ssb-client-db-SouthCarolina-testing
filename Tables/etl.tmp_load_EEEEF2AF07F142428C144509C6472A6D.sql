CREATE TABLE [etl].[tmp_load_EEEEF2AF07F142428C144509C6472A6D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_EEEEF2AF07F142428C144509C6472A6D_ss] ON [etl].[tmp_load_EEEEF2AF07F142428C144509C6472A6D] ([SourceSystem], [SSID])
GO
