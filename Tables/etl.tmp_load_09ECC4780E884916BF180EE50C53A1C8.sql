CREATE TABLE [etl].[tmp_load_09ECC4780E884916BF180EE50C53A1C8]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_09ECC4780E884916BF180EE50C53A1C8_ss] ON [etl].[tmp_load_09ECC4780E884916BF180EE50C53A1C8] ([SourceSystem], [SSID])
GO
