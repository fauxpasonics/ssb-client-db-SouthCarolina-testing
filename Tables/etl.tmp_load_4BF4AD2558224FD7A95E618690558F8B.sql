CREATE TABLE [etl].[tmp_load_4BF4AD2558224FD7A95E618690558F8B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4BF4AD2558224FD7A95E618690558F8B_ss] ON [etl].[tmp_load_4BF4AD2558224FD7A95E618690558F8B] ([SourceSystem], [SSID])
GO
