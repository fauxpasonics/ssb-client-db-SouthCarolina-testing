CREATE TABLE [etl].[tmp_load_A30F08C8F8F94455A5D6CFE002C613AB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A30F08C8F8F94455A5D6CFE002C613AB_ss] ON [etl].[tmp_load_A30F08C8F8F94455A5D6CFE002C613AB] ([SourceSystem], [SSID])
GO
