CREATE TABLE [etl].[tmp_load_C23E5CB6AA854A4F90D1D19C232EFA9F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C23E5CB6AA854A4F90D1D19C232EFA9F_ss] ON [etl].[tmp_load_C23E5CB6AA854A4F90D1D19C232EFA9F] ([SourceSystem], [SSID])
GO
