CREATE TABLE [etl].[tmp_load_AF74FA3C02DD4BA4BC96BBECD75F020C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_AF74FA3C02DD4BA4BC96BBECD75F020C_ss] ON [etl].[tmp_load_AF74FA3C02DD4BA4BC96BBECD75F020C] ([SourceSystem], [SSID])
GO
