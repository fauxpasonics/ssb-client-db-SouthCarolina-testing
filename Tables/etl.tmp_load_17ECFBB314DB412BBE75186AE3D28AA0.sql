CREATE TABLE [etl].[tmp_load_17ECFBB314DB412BBE75186AE3D28AA0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_17ECFBB314DB412BBE75186AE3D28AA0_ss] ON [etl].[tmp_load_17ECFBB314DB412BBE75186AE3D28AA0] ([SourceSystem], [SSID])
GO
