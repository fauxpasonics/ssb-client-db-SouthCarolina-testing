CREATE TABLE [etl].[tmp_load_1CC88ADC35C643D0B7212FF5005CF2C9]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1CC88ADC35C643D0B7212FF5005CF2C9_ss] ON [etl].[tmp_load_1CC88ADC35C643D0B7212FF5005CF2C9] ([SourceSystem], [SSID])
GO
