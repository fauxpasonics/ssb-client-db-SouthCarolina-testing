CREATE TABLE [etl].[tmp_load_B14F4DADE6D3466B841BDE7B8FA92E23]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B14F4DADE6D3466B841BDE7B8FA92E23_ss] ON [etl].[tmp_load_B14F4DADE6D3466B841BDE7B8FA92E23] ([SourceSystem], [SSID])
GO
