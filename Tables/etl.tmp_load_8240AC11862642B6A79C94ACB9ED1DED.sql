CREATE TABLE [etl].[tmp_load_8240AC11862642B6A79C94ACB9ED1DED]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8240AC11862642B6A79C94ACB9ED1DED_ss] ON [etl].[tmp_load_8240AC11862642B6A79C94ACB9ED1DED] ([SourceSystem], [SSID])
GO
