CREATE TABLE [etl].[tmp_load_D0B80B58E12C4FB8B84BBE128FBEA30E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D0B80B58E12C4FB8B84BBE128FBEA30E_ss] ON [etl].[tmp_load_D0B80B58E12C4FB8B84BBE128FBEA30E] ([SourceSystem], [SSID])
GO
