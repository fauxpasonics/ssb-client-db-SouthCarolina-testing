CREATE TABLE [etl].[tmp_load_6B80AEDA8B2A4297852DE21EC07ABEEC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6B80AEDA8B2A4297852DE21EC07ABEEC_ss] ON [etl].[tmp_load_6B80AEDA8B2A4297852DE21EC07ABEEC] ([SourceSystem], [SSID])
GO
