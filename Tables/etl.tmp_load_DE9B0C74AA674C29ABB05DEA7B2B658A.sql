CREATE TABLE [etl].[tmp_load_DE9B0C74AA674C29ABB05DEA7B2B658A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DE9B0C74AA674C29ABB05DEA7B2B658A_ss] ON [etl].[tmp_load_DE9B0C74AA674C29ABB05DEA7B2B658A] ([SourceSystem], [SSID])
GO
