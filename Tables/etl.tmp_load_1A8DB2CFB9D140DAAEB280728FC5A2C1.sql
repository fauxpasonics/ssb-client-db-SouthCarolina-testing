CREATE TABLE [etl].[tmp_load_1A8DB2CFB9D140DAAEB280728FC5A2C1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1A8DB2CFB9D140DAAEB280728FC5A2C1_ss] ON [etl].[tmp_load_1A8DB2CFB9D140DAAEB280728FC5A2C1] ([SourceSystem], [SSID])
GO
