CREATE TABLE [etl].[tmp_load_DD1F57C595504C4B9AE7449EDC4E9A1B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DD1F57C595504C4B9AE7449EDC4E9A1B_ss] ON [etl].[tmp_load_DD1F57C595504C4B9AE7449EDC4E9A1B] ([SourceSystem], [SSID])
GO
