CREATE TABLE [etl].[tmp_load_5A7D7B4EBF94481A9E46C50909EAC9D7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_5A7D7B4EBF94481A9E46C50909EAC9D7_ss] ON [etl].[tmp_load_5A7D7B4EBF94481A9E46C50909EAC9D7] ([SourceSystem], [SSID])
GO
