CREATE TABLE [etl].[tmp_load_F1CA5E7394944B7B8A028CFACE8881BA]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F1CA5E7394944B7B8A028CFACE8881BA_ss] ON [etl].[tmp_load_F1CA5E7394944B7B8A028CFACE8881BA] ([SourceSystem], [SSID])
GO
