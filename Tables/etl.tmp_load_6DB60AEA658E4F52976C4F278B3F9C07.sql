CREATE TABLE [etl].[tmp_load_6DB60AEA658E4F52976C4F278B3F9C07]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6DB60AEA658E4F52976C4F278B3F9C07_ss] ON [etl].[tmp_load_6DB60AEA658E4F52976C4F278B3F9C07] ([SourceSystem], [SSID])
GO
