CREATE TABLE [zzz].[archive__TM_Plans_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Create__0880433F] DEFAULT (getdate()),
...
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Plans] ON [zzz].[archive__TM_Plans_20170516] ([acct_id])
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Plans_20170516] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Plans_20170516] ([SourceFileName])
GO
