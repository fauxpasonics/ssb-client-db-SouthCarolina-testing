CREATE TABLE [zzz].[archive__TM_RetailNonTicket_20170516]
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_RetailNonTicket_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_RetailNonTicket] ON [zzz].[archive__TM_RetailNonTicket_20170516] ([event_name])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_RetailNonTicket_20170516] ([SourceFileName])
GO
