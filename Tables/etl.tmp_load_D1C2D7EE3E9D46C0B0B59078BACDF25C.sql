CREATE TABLE [etl].[tmp_load_D1C2D7EE3E9D46C0B0B59078BACDF25C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D1C2D7EE3E9D46C0B0B59078BACDF25C_ss] ON [etl].[tmp_load_D1C2D7EE3E9D46C0B0B59078BACDF25C] ([SourceSystem], [SSID])
GO
