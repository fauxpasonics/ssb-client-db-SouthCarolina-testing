CREATE TABLE [zzz].[ods__TM_AvailSeats_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Inser__239E4DCF] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Updat__24927208] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_AvailSeats_20170516] ADD CONSTRAINT [PK__TM_Avail__3213E83F0B91E718] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IX_TM_AvailSeats__class_name__INCLUDES] ON [zzz].[ods__TM_AvailSeats_20170516] ([class_name]) INCLUDE ([block_full_price], [event_name], [num_seats])
GO
CREATE NONCLUSTERED INDEX [IDX_BusinessKey] ON [zzz].[ods__TM_AvailSeats_20170516] ([event_id], [section_id], [row_id], [seat_num])
GO
