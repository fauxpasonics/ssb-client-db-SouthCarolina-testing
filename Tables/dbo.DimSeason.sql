...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__2B3F6F97] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__2C3393D0] DEFAULT (getdate()),
[IsDeleted] [bit] NULL CONSTRAINT [DF__DimSeason__IsDel__2D27B809] DEFAULT ((0)),
