CREATE TABLE [etl].[tmp_load_48C014DDE9EB426C815DCCB62E9445FB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_48C014DDE9EB426C815DCCB62E9445FB_ss] ON [etl].[tmp_load_48C014DDE9EB426C815DCCB62E9445FB] ([SourceSystem], [SSID])
GO
