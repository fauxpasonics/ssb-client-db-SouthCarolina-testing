CREATE TABLE [etl].[tmp_load_D0DE29BA72724AF782DF1F4F6D8A3B8A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D0DE29BA72724AF782DF1F4F6D8A3B8A_ss] ON [etl].[tmp_load_D0DE29BA72724AF782DF1F4F6D8A3B8A] ([SourceSystem], [SSID])
GO
