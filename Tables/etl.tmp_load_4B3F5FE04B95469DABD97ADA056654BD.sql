CREATE TABLE [etl].[tmp_load_4B3F5FE04B95469DABD97ADA056654BD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4B3F5FE04B95469DABD97ADA056654BD_ss] ON [etl].[tmp_load_4B3F5FE04B95469DABD97ADA056654BD] ([SourceSystem], [SSID])
GO
