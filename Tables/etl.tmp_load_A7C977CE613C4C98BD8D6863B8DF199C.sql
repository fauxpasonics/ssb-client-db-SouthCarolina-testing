CREATE TABLE [etl].[tmp_load_A7C977CE613C4C98BD8D6863B8DF199C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A7C977CE613C4C98BD8D6863B8DF199C_ss] ON [etl].[tmp_load_A7C977CE613C4C98BD8D6863B8DF199C] ([SourceSystem], [SSID])
GO
