CREATE TABLE [etl].[tmp_load_5B5C320DDE6B45768023B035FFD601D2]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_5B5C320DDE6B45768023B035FFD601D2_ss] ON [etl].[tmp_load_5B5C320DDE6B45768023B035FFD601D2] ([SourceSystem], [SSID])
GO
