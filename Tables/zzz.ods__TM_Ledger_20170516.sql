CREATE TABLE [zzz].[ods__TM_Ledger_20170516]
(
...
GO
ALTER TABLE [zzz].[ods__TM_Ledger_20170516] ADD CONSTRAINT [PK__TM_Ledge__3213E83F9D488394] PRIMARY KEY CLUSTERED  ([id])
GO
