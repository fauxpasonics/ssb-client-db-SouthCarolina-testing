CREATE TABLE [etl].[tmp_load_2CDA696FEAFF44ECAEC08EBD1447A9D8]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2CDA696FEAFF44ECAEC08EBD1447A9D8_ss] ON [etl].[tmp_load_2CDA696FEAFF44ECAEC08EBD1447A9D8] ([SourceSystem], [SSID])
GO
