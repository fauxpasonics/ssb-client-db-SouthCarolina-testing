CREATE TABLE [etl].[tmp_load_5D383B55DB774A17A6D6460C39F7091D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_5D383B55DB774A17A6D6460C39F7091D_ss] ON [etl].[tmp_load_5D383B55DB774A17A6D6460C39F7091D] ([SourceSystem], [SSID])
GO
