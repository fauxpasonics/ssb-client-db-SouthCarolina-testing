CREATE TABLE [etl].[tmp_load_1AAAADC3EE3B48F08DB11699C5878CC0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1AAAADC3EE3B48F08DB11699C5878CC0_ss] ON [etl].[tmp_load_1AAAADC3EE3B48F08DB11699C5878CC0] ([SourceSystem], [SSID])
GO
