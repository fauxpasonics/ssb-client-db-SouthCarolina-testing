CREATE TABLE [etl].[tmp_load_7FDFE86623804340BADB14C5A7AB9694]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7FDFE86623804340BADB14C5A7AB9694_ss] ON [etl].[tmp_load_7FDFE86623804340BADB14C5A7AB9694] ([SourceSystem], [SSID])
GO
