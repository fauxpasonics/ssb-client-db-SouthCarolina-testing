CREATE TABLE [etl].[tmp_load_F189827EA25D4A58B5A124417C54A8FB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F189827EA25D4A58B5A124417C54A8FB_ss] ON [etl].[tmp_load_F189827EA25D4A58B5A124417C54A8FB] ([SourceSystem], [SSID])
GO
