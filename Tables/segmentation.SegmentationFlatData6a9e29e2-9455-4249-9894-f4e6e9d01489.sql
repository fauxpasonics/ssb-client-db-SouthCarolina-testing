CREATE TABLE [segmentation].[SegmentationFlatData6a9e29e2-9455-4249-9894-f4e6e9d01489]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData6a9e29e2-9455-4249-9894-f4e6e9d01489] ADD CONSTRAINT [pk_SegmentationFlatData6a9e29e2-9455-4249-9894-f4e6e9d01489] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData6a9e29e2-9455-4249-9894-f4e6e9d01489] ON [segmentation].[SegmentationFlatData6a9e29e2-9455-4249-9894-f4e6e9d01489] ([_rn])
GO
