CREATE TABLE [etl].[tmp_load_747A241793DD412492FDC5AB2B8DDCA1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_747A241793DD412492FDC5AB2B8DDCA1_ss] ON [etl].[tmp_load_747A241793DD412492FDC5AB2B8DDCA1] ([SourceSystem], [SSID])
GO
