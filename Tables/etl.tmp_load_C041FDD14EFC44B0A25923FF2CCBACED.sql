CREATE TABLE [etl].[tmp_load_C041FDD14EFC44B0A25923FF2CCBACED]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C041FDD14EFC44B0A25923FF2CCBACED_ss] ON [etl].[tmp_load_C041FDD14EFC44B0A25923FF2CCBACED] ([SourceSystem], [SSID])
GO
