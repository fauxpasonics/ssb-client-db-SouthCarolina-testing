CREATE TABLE [etl].[tmp_load_78E3516282CB441B9B7D3247C14A74F1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_78E3516282CB441B9B7D3247C14A74F1_ss] ON [etl].[tmp_load_78E3516282CB441B9B7D3247C14A74F1] ([SourceSystem], [SSID])
GO
