CREATE TABLE [etl].[tmp_load_FAD7A95B829B4ABFB83431FC0F10CCDB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FAD7A95B829B4ABFB83431FC0F10CCDB_ss] ON [etl].[tmp_load_FAD7A95B829B4ABFB83431FC0F10CCDB] ([SourceSystem], [SSID])
GO
