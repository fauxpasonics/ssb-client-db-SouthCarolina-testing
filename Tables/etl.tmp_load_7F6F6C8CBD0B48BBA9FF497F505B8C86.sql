CREATE TABLE [etl].[tmp_load_7F6F6C8CBD0B48BBA9FF497F505B8C86]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7F6F6C8CBD0B48BBA9FF497F505B8C86_ss] ON [etl].[tmp_load_7F6F6C8CBD0B48BBA9FF497F505B8C86] ([SourceSystem], [SSID])
GO
