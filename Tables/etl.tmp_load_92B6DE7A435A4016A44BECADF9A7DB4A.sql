CREATE TABLE [etl].[tmp_load_92B6DE7A435A4016A44BECADF9A7DB4A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_92B6DE7A435A4016A44BECADF9A7DB4A_ss] ON [etl].[tmp_load_92B6DE7A435A4016A44BECADF9A7DB4A] ([SourceSystem], [SSID])
GO
