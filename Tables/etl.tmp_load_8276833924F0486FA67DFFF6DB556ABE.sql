CREATE TABLE [etl].[tmp_load_8276833924F0486FA67DFFF6DB556ABE]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8276833924F0486FA67DFFF6DB556ABE_ss] ON [etl].[tmp_load_8276833924F0486FA67DFFF6DB556ABE] ([SourceSystem], [SSID])
GO
