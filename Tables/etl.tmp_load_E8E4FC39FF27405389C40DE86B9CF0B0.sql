CREATE TABLE [etl].[tmp_load_E8E4FC39FF27405389C40DE86B9CF0B0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E8E4FC39FF27405389C40DE86B9CF0B0_ss] ON [etl].[tmp_load_E8E4FC39FF27405389C40DE86B9CF0B0] ([SourceSystem], [SSID])
GO
