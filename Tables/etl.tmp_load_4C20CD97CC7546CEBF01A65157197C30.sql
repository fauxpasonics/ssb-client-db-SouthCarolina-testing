CREATE TABLE [etl].[tmp_load_4C20CD97CC7546CEBF01A65157197C30]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4C20CD97CC7546CEBF01A65157197C30_ss] ON [etl].[tmp_load_4C20CD97CC7546CEBF01A65157197C30] ([SourceSystem], [SSID])
GO
