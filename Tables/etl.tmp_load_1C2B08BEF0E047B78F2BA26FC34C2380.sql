CREATE TABLE [etl].[tmp_load_1C2B08BEF0E047B78F2BA26FC34C2380]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1C2B08BEF0E047B78F2BA26FC34C2380_ss] ON [etl].[tmp_load_1C2B08BEF0E047B78F2BA26FC34C2380] ([SourceSystem], [SSID])
GO
