CREATE TABLE [etl].[tmp_load_D80B6A2C061B49D3A2FA0AF14A7CF9C7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D80B6A2C061B49D3A2FA0AF14A7CF9C7_ss] ON [etl].[tmp_load_D80B6A2C061B49D3A2FA0AF14A7CF9C7] ([SourceSystem], [SSID])
GO
