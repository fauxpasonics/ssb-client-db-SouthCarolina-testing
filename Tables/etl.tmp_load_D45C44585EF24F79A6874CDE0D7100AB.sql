CREATE TABLE [etl].[tmp_load_D45C44585EF24F79A6874CDE0D7100AB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D45C44585EF24F79A6874CDE0D7100AB_ss] ON [etl].[tmp_load_D45C44585EF24F79A6874CDE0D7100AB] ([SourceSystem], [SSID])
GO
