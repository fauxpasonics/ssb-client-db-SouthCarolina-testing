CREATE TABLE [etl].[tmp_load_F1116C54BBCF4AF8825C47FC9A27207C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F1116C54BBCF4AF8825C47FC9A27207C_ss] ON [etl].[tmp_load_F1116C54BBCF4AF8825C47FC9A27207C] ([SourceSystem], [SSID])
GO
