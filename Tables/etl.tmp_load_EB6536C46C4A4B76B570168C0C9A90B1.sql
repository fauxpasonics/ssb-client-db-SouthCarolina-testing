CREATE TABLE [etl].[tmp_load_EB6536C46C4A4B76B570168C0C9A90B1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_EB6536C46C4A4B76B570168C0C9A90B1_ss] ON [etl].[tmp_load_EB6536C46C4A4B76B570168C0C9A90B1] ([SourceSystem], [SSID])
GO
