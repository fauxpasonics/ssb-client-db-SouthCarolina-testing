CREATE TABLE [etl].[tmp_load_6FA011C4009B4B5A8C510867A2C91D78]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6FA011C4009B4B5A8C510867A2C91D78_ss] ON [etl].[tmp_load_6FA011C4009B4B5A8C510867A2C91D78] ([SourceSystem], [SSID])
GO
