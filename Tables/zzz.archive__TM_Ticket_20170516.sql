CREATE TABLE [zzz].[archive__TM_Ticket_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Ticket__Creat__1E6F845E] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Ticket_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Ticket] ON [zzz].[archive__TM_Ticket_20170516] ([event_name])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Ticket_20170516] ([SourceFileName])
GO
