CREATE TABLE [etl].[tmp_load_221DD236B8B94F52977B7CA6EDBCA7F1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_221DD236B8B94F52977B7CA6EDBCA7F1_ss] ON [etl].[tmp_load_221DD236B8B94F52977B7CA6EDBCA7F1] ([SourceSystem], [SSID])
GO
