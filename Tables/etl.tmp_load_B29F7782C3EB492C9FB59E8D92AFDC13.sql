CREATE TABLE [etl].[tmp_load_B29F7782C3EB492C9FB59E8D92AFDC13]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B29F7782C3EB492C9FB59E8D92AFDC13_ss] ON [etl].[tmp_load_B29F7782C3EB492C9FB59E8D92AFDC13] ([SourceSystem], [SSID])
GO
