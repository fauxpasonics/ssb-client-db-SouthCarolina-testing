...
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_sourcesystem_customertype_include] ON [dbo].[DimCustomer] ([SourceSystem], [CustomerType]) INCLUDE ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer__SourceSystem__CustomerType__Includes] ON [dbo].[DimCustomer] ([SourceSystem], [CustomerType]) INCLUDE ([AccountId], [DimCustomerId])
GO
