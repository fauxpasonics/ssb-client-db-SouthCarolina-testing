CREATE TABLE [etl].[tmp_load_D0889AE753CE4E0D814E14C9832C7B0E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D0889AE753CE4E0D814E14C9832C7B0E_ss] ON [etl].[tmp_load_D0889AE753CE4E0D814E14C9832C7B0E] ([SourceSystem], [SSID])
GO
