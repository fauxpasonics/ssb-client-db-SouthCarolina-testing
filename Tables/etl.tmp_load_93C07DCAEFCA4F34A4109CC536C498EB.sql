CREATE TABLE [etl].[tmp_load_93C07DCAEFCA4F34A4109CC536C498EB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_93C07DCAEFCA4F34A4109CC536C498EB_ss] ON [etl].[tmp_load_93C07DCAEFCA4F34A4109CC536C498EB] ([SourceSystem], [SSID])
GO
