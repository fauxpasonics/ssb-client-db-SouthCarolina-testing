CREATE TABLE [etl].[tmp_load_6A0FE264C6A14EDF984043271C3BADE3]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6A0FE264C6A14EDF984043271C3BADE3_ss] ON [etl].[tmp_load_6A0FE264C6A14EDF984043271C3BADE3] ([SourceSystem], [SSID])
GO
