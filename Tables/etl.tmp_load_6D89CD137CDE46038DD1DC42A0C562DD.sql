CREATE TABLE [etl].[tmp_load_6D89CD137CDE46038DD1DC42A0C562DD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6D89CD137CDE46038DD1DC42A0C562DD_ss] ON [etl].[tmp_load_6D89CD137CDE46038DD1DC42A0C562DD] ([SourceSystem], [SSID])
GO
