CREATE TABLE [etl].[tmp_load_F3B68B8969AA4F3A8FD47F29013C8BF7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F3B68B8969AA4F3A8FD47F29013C8BF7_ss] ON [etl].[tmp_load_F3B68B8969AA4F3A8FD47F29013C8BF7] ([SourceSystem], [SSID])
GO
