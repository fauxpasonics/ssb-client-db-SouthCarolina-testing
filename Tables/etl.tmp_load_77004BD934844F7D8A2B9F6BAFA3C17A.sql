CREATE TABLE [etl].[tmp_load_77004BD934844F7D8A2B9F6BAFA3C17A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_77004BD934844F7D8A2B9F6BAFA3C17A_ss] ON [etl].[tmp_load_77004BD934844F7D8A2B9F6BAFA3C17A] ([SourceSystem], [SSID])
GO
