CREATE TABLE [etl].[tmp_load_E1B4C3A07CC042C7A30D9B54E638B636]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E1B4C3A07CC042C7A30D9B54E638B636_ss] ON [etl].[tmp_load_E1B4C3A07CC042C7A30D9B54E638B636] ([SourceSystem], [SSID])
GO
