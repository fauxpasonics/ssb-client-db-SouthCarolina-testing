CREATE TABLE [etl].[tmp_load_5D6F0B7A641E46C58AABAA79B30079C4]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_5D6F0B7A641E46C58AABAA79B30079C4_ss] ON [etl].[tmp_load_5D6F0B7A641E46C58AABAA79B30079C4] ([SourceSystem], [SSID])
GO
