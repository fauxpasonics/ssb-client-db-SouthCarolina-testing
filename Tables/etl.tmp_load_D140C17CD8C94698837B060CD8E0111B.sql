CREATE TABLE [etl].[tmp_load_D140C17CD8C94698837B060CD8E0111B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D140C17CD8C94698837B060CD8E0111B_ss] ON [etl].[tmp_load_D140C17CD8C94698837B060CD8E0111B] ([SourceSystem], [SSID])
GO
