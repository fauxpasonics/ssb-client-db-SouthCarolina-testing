CREATE TABLE [etl].[tmp_load_F8F2FB1812BC4FB2AEA8D0B8AC5EF737]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F8F2FB1812BC4FB2AEA8D0B8AC5EF737_ss] ON [etl].[tmp_load_F8F2FB1812BC4FB2AEA8D0B8AC5EF737] ([SourceSystem], [SSID])
GO
