CREATE TABLE [etl].[tmp_load_8139044759984FCD87FEE82A1C208B2C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8139044759984FCD87FEE82A1C208B2C_ss] ON [etl].[tmp_load_8139044759984FCD87FEE82A1C208B2C] ([SourceSystem], [SSID])
GO
