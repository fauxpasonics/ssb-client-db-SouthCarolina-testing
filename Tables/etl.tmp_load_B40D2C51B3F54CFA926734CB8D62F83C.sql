CREATE TABLE [etl].[tmp_load_B40D2C51B3F54CFA926734CB8D62F83C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B40D2C51B3F54CFA926734CB8D62F83C_ss] ON [etl].[tmp_load_B40D2C51B3F54CFA926734CB8D62F83C] ([SourceSystem], [SSID])
GO
