CREATE TABLE [etl].[tmp_load_89692DFB016B4E1B80C19E7FF6583E7B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_89692DFB016B4E1B80C19E7FF6583E7B_ss] ON [etl].[tmp_load_89692DFB016B4E1B80C19E7FF6583E7B] ([SourceSystem], [SSID])
GO
