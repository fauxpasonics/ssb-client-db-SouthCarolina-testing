CREATE TABLE [etl].[tmp_load_224B191790704678AEF97DC2B2EC0A88]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_224B191790704678AEF97DC2B2EC0A88_ss] ON [etl].[tmp_load_224B191790704678AEF97DC2B2EC0A88] ([SourceSystem], [SSID])
GO
