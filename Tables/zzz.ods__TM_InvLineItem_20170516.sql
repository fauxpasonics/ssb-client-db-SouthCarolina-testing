CREATE TABLE [zzz].[ods__TM_InvLineItem_20170516]
(
...
GO
ALTER TABLE [zzz].[ods__TM_InvLineItem_20170516] ADD CONSTRAINT [PK__TM_InvLi__3213E83FFDB33949] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_TMInvLineItem_OrderNum_OrderLineItem_OrderLineSeqIItem_InvoiceID] ON [zzz].[ods__TM_InvLineItem_20170516] ([order_num], [order_line_item], [order_line_item_seq], [invoice_id])
GO
