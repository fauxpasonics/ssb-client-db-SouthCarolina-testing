CREATE TABLE [etl].[tmp_load_2D83C27EF5594B0392DED8F1910B2471]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2D83C27EF5594B0392DED8F1910B2471_ss] ON [etl].[tmp_load_2D83C27EF5594B0392DED8F1910B2471] ([SourceSystem], [SSID])
GO
