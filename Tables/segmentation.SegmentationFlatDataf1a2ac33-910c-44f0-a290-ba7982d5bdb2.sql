CREATE TABLE [segmentation].[SegmentationFlatDataf1a2ac33-910c-44f0-a290-ba7982d5bdb2]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataf1a2ac33-910c-44f0-a290-ba7982d5bdb2] ADD CONSTRAINT [pk_SegmentationFlatDataf1a2ac33-910c-44f0-a290-ba7982d5bdb2] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataf1a2ac33-910c-44f0-a290-ba7982d5bdb2] ON [segmentation].[SegmentationFlatDataf1a2ac33-910c-44f0-a290-ba7982d5bdb2] ([_rn])
GO
