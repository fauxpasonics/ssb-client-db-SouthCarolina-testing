CREATE TABLE [etl].[tmp_load_E3AB4BA2250841C1BE6AEB9B3A2FFC52]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E3AB4BA2250841C1BE6AEB9B3A2FFC52_ss] ON [etl].[tmp_load_E3AB4BA2250841C1BE6AEB9B3A2FFC52] ([SourceSystem], [SSID])
GO
