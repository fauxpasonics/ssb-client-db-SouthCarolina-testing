CREATE TABLE [zzz].[ods__TM_Journal_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Inser__5165187F] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Updat__52593CB8] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Journal_20170516] ADD CONSTRAINT [PK__TM_Journ__3213E83FE74A200C] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_TMJournal_JournalSeqID] ON [zzz].[ods__TM_Journal_20170516] ([journal_Seq_id])
GO
