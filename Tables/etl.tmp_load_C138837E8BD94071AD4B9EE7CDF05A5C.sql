CREATE TABLE [etl].[tmp_load_C138837E8BD94071AD4B9EE7CDF05A5C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C138837E8BD94071AD4B9EE7CDF05A5C_ss] ON [etl].[tmp_load_C138837E8BD94071AD4B9EE7CDF05A5C] ([SourceSystem], [SSID])
GO
