CREATE TABLE [etl].[tmp_load_D6D053F70F584C27A45EF797318678EC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D6D053F70F584C27A45EF797318678EC_ss] ON [etl].[tmp_load_D6D053F70F584C27A45EF797318678EC] ([SourceSystem], [SSID])
GO
