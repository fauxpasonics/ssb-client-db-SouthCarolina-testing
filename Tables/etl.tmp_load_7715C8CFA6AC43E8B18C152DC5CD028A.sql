CREATE TABLE [etl].[tmp_load_7715C8CFA6AC43E8B18C152DC5CD028A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7715C8CFA6AC43E8B18C152DC5CD028A_ss] ON [etl].[tmp_load_7715C8CFA6AC43E8B18C152DC5CD028A] ([SourceSystem], [SSID])
GO
