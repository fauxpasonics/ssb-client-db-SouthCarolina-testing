CREATE TABLE [etl].[tmp_load_71C1DC181CDF46D6BDB84DFB522259B4]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_71C1DC181CDF46D6BDB84DFB522259B4_ss] ON [etl].[tmp_load_71C1DC181CDF46D6BDB84DFB522259B4] ([SourceSystem], [SSID])
GO
