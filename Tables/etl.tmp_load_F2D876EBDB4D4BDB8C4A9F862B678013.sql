CREATE TABLE [etl].[tmp_load_F2D876EBDB4D4BDB8C4A9F862B678013]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F2D876EBDB4D4BDB8C4A9F862B678013_ss] ON [etl].[tmp_load_F2D876EBDB4D4BDB8C4A9F862B678013] ([SourceSystem], [SSID])
GO
