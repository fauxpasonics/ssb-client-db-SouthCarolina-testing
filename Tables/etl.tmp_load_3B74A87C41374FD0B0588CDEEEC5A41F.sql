CREATE TABLE [etl].[tmp_load_3B74A87C41374FD0B0588CDEEEC5A41F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3B74A87C41374FD0B0588CDEEEC5A41F_ss] ON [etl].[tmp_load_3B74A87C41374FD0B0588CDEEEC5A41F] ([SourceSystem], [SSID])
GO
