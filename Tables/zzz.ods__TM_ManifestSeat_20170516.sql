CREATE TABLE [zzz].[ods__TM_ManifestSeat_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__59FA5E80] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__5AEE82B9] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_ManifestSeat_20170516] ADD CONSTRAINT [PK__TM_Manif__3213E83F5C4D7DE3] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_BusinessKey] ON [zzz].[ods__TM_ManifestSeat_20170516] ([manifest_id], [section_id], [row_id], [seat_num])
GO
