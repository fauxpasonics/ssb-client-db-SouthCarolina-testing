CREATE TABLE [etl].[tmp_load_D9BE6B52D7BC48BEA7EACFBEB5BB6176]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D9BE6B52D7BC48BEA7EACFBEB5BB6176_ss] ON [etl].[tmp_load_D9BE6B52D7BC48BEA7EACFBEB5BB6176] ([SourceSystem], [SSID])
GO
