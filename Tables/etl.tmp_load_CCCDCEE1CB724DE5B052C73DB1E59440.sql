CREATE TABLE [etl].[tmp_load_CCCDCEE1CB724DE5B052C73DB1E59440]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CCCDCEE1CB724DE5B052C73DB1E59440_ss] ON [etl].[tmp_load_CCCDCEE1CB724DE5B052C73DB1E59440] ([SourceSystem], [SSID])
GO
