CREATE TABLE [etl].[tmp_load_074BEE5AFE154F39AF745B659C8D6838]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_074BEE5AFE154F39AF745B659C8D6838_ss] ON [etl].[tmp_load_074BEE5AFE154F39AF745B659C8D6838] ([SourceSystem], [SSID])
GO
