CREATE TABLE [etl].[tmp_load_D2E03B54405B4485B8C8A7F4DE2EDB1C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D2E03B54405B4485B8C8A7F4DE2EDB1C_ss] ON [etl].[tmp_load_D2E03B54405B4485B8C8A7F4DE2EDB1C] ([SourceSystem], [SSID])
GO
