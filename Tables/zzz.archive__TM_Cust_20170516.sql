CREATE TABLE [zzz].[archive__TM_Cust_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__Created__793DFFAF] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Cust] ON [zzz].[archive__TM_Cust_20170516] ([acct_id])
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Cust_20170516] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Cust_20170516] ([SourceFileName])
GO
