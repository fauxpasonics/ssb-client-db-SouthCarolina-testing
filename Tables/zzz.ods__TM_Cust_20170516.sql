CREATE TABLE [zzz].[ods__TM_Cust_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__InsertD__30F848ED] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__UpdateD__31EC6D26] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL,
[name_type] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [zzz].[ods__TM_Cust_20170516] ADD CONSTRAINT [PK__TM_Cust__3213E83FA172FC19] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_acct_id] ON [zzz].[ods__TM_Cust_20170516] ([acct_id])
GO
