CREATE TABLE [etl].[tmp_load_74C23B99ABF74EC9AD917B7DFCB3EDDE]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_74C23B99ABF74EC9AD917B7DFCB3EDDE_ss] ON [etl].[tmp_load_74C23B99ABF74EC9AD917B7DFCB3EDDE] ([SourceSystem], [SSID])
GO
