CREATE TABLE [etl].[tmp_load_FE59DC1F2D814C728C778358A9421A1E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FE59DC1F2D814C728C778358A9421A1E_ss] ON [etl].[tmp_load_FE59DC1F2D814C728C778358A9421A1E] ([SourceSystem], [SSID])
GO
