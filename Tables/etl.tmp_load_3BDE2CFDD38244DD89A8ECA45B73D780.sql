CREATE TABLE [etl].[tmp_load_3BDE2CFDD38244DD89A8ECA45B73D780]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3BDE2CFDD38244DD89A8ECA45B73D780_ss] ON [etl].[tmp_load_3BDE2CFDD38244DD89A8ECA45B73D780] ([SourceSystem], [SSID])
GO
