CREATE TABLE [etl].[tmp_load_6D7AE1A6DBE0448C8B635AEA04C94A46]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6D7AE1A6DBE0448C8B635AEA04C94A46_ss] ON [etl].[tmp_load_6D7AE1A6DBE0448C8B635AEA04C94A46] ([SourceSystem], [SSID])
GO
