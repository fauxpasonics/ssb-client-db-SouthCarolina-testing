CREATE TABLE [etl].[tmp_load_0C190533E93845C09E1752E0DE60B44F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0C190533E93845C09E1752E0DE60B44F_ss] ON [etl].[tmp_load_0C190533E93845C09E1752E0DE60B44F] ([SourceSystem], [SSID])
GO
