CREATE TABLE [zzz].[ods__TM_Plans_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__6E01572D] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__6EF57B66] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Plans_20170516] ADD CONSTRAINT [PK__TM_Plans__3213E83F36B84F64] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_PlanKey] ON [zzz].[ods__TM_Plans_20170516] ([acct_id], [plan_event_id], [ticket_status], [section_id], [row_id], [seat_num]) INCLUDE ([num_seats], [ssbPriceCode])
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [zzz].[ods__TM_Plans_20170516] ([ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_UpdateDate] ON [zzz].[ods__TM_Plans_20170516] ([UpdateDate])
GO
