CREATE TABLE [etl].[tmp_load_585EC008AB6449488052BFDC47B13F0D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_585EC008AB6449488052BFDC47B13F0D_ss] ON [etl].[tmp_load_585EC008AB6449488052BFDC47B13F0D] ([SourceSystem], [SSID])
GO
