CREATE TABLE [zzz].[archive__TM_Class_20170516]
(
...
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Class] ON [zzz].[archive__TM_Class_20170516] ([class_id])
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Class_20170516] ([CreatedDate])
GO
