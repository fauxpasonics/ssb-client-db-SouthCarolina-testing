CREATE TABLE [etl].[tmp_load_093B7D64B4254BABAE7EF25BD0587DA0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_093B7D64B4254BABAE7EF25BD0587DA0_ss] ON [etl].[tmp_load_093B7D64B4254BABAE7EF25BD0587DA0] ([SourceSystem], [SSID])
GO
