CREATE TABLE [zzz].[ods__TM_PromoCode_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Inser__45F365D3] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Updat__46E78A0C] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_PromoCode_20170516] ADD CONSTRAINT [PK__TM_Promo__3213E83FAB153005] PRIMARY KEY CLUSTERED  ([id])
GO
