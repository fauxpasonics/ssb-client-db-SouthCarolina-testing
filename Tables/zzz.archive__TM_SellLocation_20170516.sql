CREATE TABLE [zzz].[archive__TM_SellLocation_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_SellLo__Creat__10216507] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_SellLocation_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_SellLocation] ON [zzz].[archive__TM_SellLocation_20170516] ([sell_location_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_SellLocation_20170516] ([SourceFileName])
GO
