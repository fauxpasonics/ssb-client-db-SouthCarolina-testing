...
GO
ALTER TABLE [dbo].[DimSeat_V2] ADD CONSTRAINT [PK_dbo__DimSeat_V2] PRIMARY KEY CLUSTERED  ([DimSeatId])
GO
CREATE NONCLUSTERED INDEX [DimSeat_SeatId] ON [dbo].[DimSeat_V2] ([DimSeatId]) INCLUDE ([RowName], [SectionName])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimSeat_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimSeat_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_KEY_TM] ON [dbo].[DimSeat_V2] ([ETL__SSID_TM_manifest_id], [ETL__SSID_TM_section_id], [ETL__SSID_TM_row_id], [ETL__SSID_TM_seat])
GO
