CREATE TABLE [etl].[tmp_load_BA3A714B7EDA40B8ADC68FD333E58C32]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_BA3A714B7EDA40B8ADC68FD333E58C32_ss] ON [etl].[tmp_load_BA3A714B7EDA40B8ADC68FD333E58C32] ([SourceSystem], [SSID])
GO
