CREATE TABLE [etl].[tmp_load_FD085251568F4D3C86BDB54874B5B225]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FD085251568F4D3C86BDB54874B5B225_ss] ON [etl].[tmp_load_FD085251568F4D3C86BDB54874B5B225] ([SourceSystem], [SSID])
GO
