CREATE TABLE [zzz].[archive__TM_Tex_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__CreatedD__13F1F5EB] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Tex_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Tex] ON [zzz].[archive__TM_Tex_20170516] ([event_name])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Tex_20170516] ([SourceFileName])
GO
