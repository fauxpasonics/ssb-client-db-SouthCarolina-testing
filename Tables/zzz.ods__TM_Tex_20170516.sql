CREATE TABLE [zzz].[ods__TM_Tex_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__InsertDa__0A9D95DB] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__UpdateDa__0B91BA14] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Tex_20170516] ADD CONSTRAINT [PK__TM_Tex__3213E83FF7694C64] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX__TMTex_Activity] ON [zzz].[ods__TM_Tex_20170516] ([activity])
GO
CREATE NONCLUSTERED INDEX [IX_TM_Tex__activity__INCLUDES] ON [zzz].[ods__TM_Tex_20170516] ([activity]) INCLUDE ([event_name], [num_seats], [te_purchase_price])
GO
