CREATE TABLE [etl].[tmp_load_9F23D7D4BBF740F6B7CAF8261A50C77D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9F23D7D4BBF740F6B7CAF8261A50C77D_ss] ON [etl].[tmp_load_9F23D7D4BBF740F6B7CAF8261A50C77D] ([SourceSystem], [SSID])
GO
