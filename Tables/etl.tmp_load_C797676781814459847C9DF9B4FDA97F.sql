CREATE TABLE [etl].[tmp_load_C797676781814459847C9DF9B4FDA97F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C797676781814459847C9DF9B4FDA97F_ss] ON [etl].[tmp_load_C797676781814459847C9DF9B4FDA97F] ([SourceSystem], [SSID])
GO
