CREATE TABLE [etl].[tmp_load_6D467EA8A4FD4D6CB974429FF62448B1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6D467EA8A4FD4D6CB974429FF62448B1_ss] ON [etl].[tmp_load_6D467EA8A4FD4D6CB974429FF62448B1] ([SourceSystem], [SSID])
GO
