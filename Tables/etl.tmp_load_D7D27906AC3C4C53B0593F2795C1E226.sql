CREATE TABLE [etl].[tmp_load_D7D27906AC3C4C53B0593F2795C1E226]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D7D27906AC3C4C53B0593F2795C1E226_ss] ON [etl].[tmp_load_D7D27906AC3C4C53B0593F2795C1E226] ([SourceSystem], [SSID])
GO
