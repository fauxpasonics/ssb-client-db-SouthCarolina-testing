CREATE TABLE [segmentation].[SegmentationFlatDataf2338600-bde2-4606-a7e1-688a633e0fb6]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataf2338600-bde2-4606-a7e1-688a633e0fb6] ADD CONSTRAINT [pk_SegmentationFlatDataf2338600-bde2-4606-a7e1-688a633e0fb6] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataf2338600-bde2-4606-a7e1-688a633e0fb6] ON [segmentation].[SegmentationFlatDataf2338600-bde2-4606-a7e1-688a633e0fb6] ([_rn])
GO
