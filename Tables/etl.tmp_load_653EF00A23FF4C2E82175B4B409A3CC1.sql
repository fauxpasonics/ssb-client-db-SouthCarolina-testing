CREATE TABLE [etl].[tmp_load_653EF00A23FF4C2E82175B4B409A3CC1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_653EF00A23FF4C2E82175B4B409A3CC1_ss] ON [etl].[tmp_load_653EF00A23FF4C2E82175B4B409A3CC1] ([SourceSystem], [SSID])
GO
