CREATE TABLE [zzz].[archive__TM_Season_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Season__Creat__0E391C95] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Season_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Season] ON [zzz].[archive__TM_Season_20170516] ([season_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Season_20170516] ([SourceFileName])
GO
