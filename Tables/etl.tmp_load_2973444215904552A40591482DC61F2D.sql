CREATE TABLE [etl].[tmp_load_2973444215904552A40591482DC61F2D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2973444215904552A40591482DC61F2D_ss] ON [etl].[tmp_load_2973444215904552A40591482DC61F2D] ([SourceSystem], [SSID])
GO
