CREATE TABLE [zzz].[ods__TM_PaySchedule_20170516]
(
...
GO
ALTER TABLE [zzz].[ods__TM_PaySchedule_20170516] ADD CONSTRAINT [PK__TM_PaySc__3213E83F4219E5F5] PRIMARY KEY CLUSTERED  ([id])
GO
