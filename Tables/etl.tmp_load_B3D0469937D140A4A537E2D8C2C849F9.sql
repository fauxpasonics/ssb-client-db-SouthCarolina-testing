CREATE TABLE [etl].[tmp_load_B3D0469937D140A4A537E2D8C2C849F9]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B3D0469937D140A4A537E2D8C2C849F9_ss] ON [etl].[tmp_load_B3D0469937D140A4A537E2D8C2C849F9] ([SourceSystem], [SSID])
GO
