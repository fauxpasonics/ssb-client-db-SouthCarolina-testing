CREATE TABLE [etl].[tmp_load_235DEB0312544DD3BBC469D50073ADFC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_235DEB0312544DD3BBC469D50073ADFC_ss] ON [etl].[tmp_load_235DEB0312544DD3BBC469D50073ADFC] ([SourceSystem], [SSID])
GO
