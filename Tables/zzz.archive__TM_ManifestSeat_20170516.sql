CREATE TABLE [zzz].[archive__TM_ManifestSeat_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Creat__04AFB25B] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_ManifestSeat] ON [zzz].[archive__TM_ManifestSeat_20170516] ([arena_id])
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_ManifestSeat_20170516] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_ManifestSeat_20170516] ([SourceFileName])
GO
