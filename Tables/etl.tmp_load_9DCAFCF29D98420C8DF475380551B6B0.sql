CREATE TABLE [etl].[tmp_load_9DCAFCF29D98420C8DF475380551B6B0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9DCAFCF29D98420C8DF475380551B6B0_ss] ON [etl].[tmp_load_9DCAFCF29D98420C8DF475380551B6B0] ([SourceSystem], [SSID])
GO
