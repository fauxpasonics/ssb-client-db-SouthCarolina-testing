CREATE TABLE [etl].[tmp_load_FE6C9D7C5B1D43FA89A00BD28C2C58C7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FE6C9D7C5B1D43FA89A00BD28C2C58C7_ss] ON [etl].[tmp_load_FE6C9D7C5B1D43FA89A00BD28C2C58C7] ([SourceSystem], [SSID])
GO
