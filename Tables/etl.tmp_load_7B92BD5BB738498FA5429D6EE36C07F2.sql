CREATE TABLE [etl].[tmp_load_7B92BD5BB738498FA5429D6EE36C07F2]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7B92BD5BB738498FA5429D6EE36C07F2_ss] ON [etl].[tmp_load_7B92BD5BB738498FA5429D6EE36C07F2] ([SourceSystem], [SSID])
GO
