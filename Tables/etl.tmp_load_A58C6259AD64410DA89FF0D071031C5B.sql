CREATE TABLE [etl].[tmp_load_A58C6259AD64410DA89FF0D071031C5B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A58C6259AD64410DA89FF0D071031C5B_ss] ON [etl].[tmp_load_A58C6259AD64410DA89FF0D071031C5B] ([SourceSystem], [SSID])
GO
