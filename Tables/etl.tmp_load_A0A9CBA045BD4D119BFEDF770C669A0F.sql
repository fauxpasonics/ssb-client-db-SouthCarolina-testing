CREATE TABLE [etl].[tmp_load_A0A9CBA045BD4D119BFEDF770C669A0F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A0A9CBA045BD4D119BFEDF770C669A0F_ss] ON [etl].[tmp_load_A0A9CBA045BD4D119BFEDF770C669A0F] ([SourceSystem], [SSID])
GO
