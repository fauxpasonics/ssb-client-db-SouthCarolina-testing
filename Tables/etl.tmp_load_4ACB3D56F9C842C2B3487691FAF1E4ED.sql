CREATE TABLE [etl].[tmp_load_4ACB3D56F9C842C2B3487691FAF1E4ED]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4ACB3D56F9C842C2B3487691FAF1E4ED_ss] ON [etl].[tmp_load_4ACB3D56F9C842C2B3487691FAF1E4ED] ([SourceSystem], [SSID])
GO
