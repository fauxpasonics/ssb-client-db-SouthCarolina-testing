CREATE TABLE [zzz].[archive__TM_CustAddress_20170516]
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_CustAddress_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_CustAddress] ON [zzz].[archive__TM_CustAddress_20170516] ([cust_name_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_CustAddress_20170516] ([SourceFileName])
GO
