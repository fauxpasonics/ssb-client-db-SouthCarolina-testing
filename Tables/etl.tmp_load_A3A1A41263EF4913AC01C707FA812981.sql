CREATE TABLE [etl].[tmp_load_A3A1A41263EF4913AC01C707FA812981]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A3A1A41263EF4913AC01C707FA812981_ss] ON [etl].[tmp_load_A3A1A41263EF4913AC01C707FA812981] ([SourceSystem], [SSID])
GO
