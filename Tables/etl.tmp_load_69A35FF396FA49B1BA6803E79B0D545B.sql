CREATE TABLE [etl].[tmp_load_69A35FF396FA49B1BA6803E79B0D545B]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_69A35FF396FA49B1BA6803E79B0D545B_ss] ON [etl].[tmp_load_69A35FF396FA49B1BA6803E79B0D545B] ([SourceSystem], [SSID])
GO
