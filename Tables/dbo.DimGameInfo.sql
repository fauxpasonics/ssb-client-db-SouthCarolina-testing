...
[OvertimePeriods] [int] NULL CONSTRAINT [DF__DimGameIn__Overt__65370702] DEFAULT ((0)),
[CreatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimGameIn__Creat__662B2B3B] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimGameIn__Updat__671F4F74] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimGameIn__IsDel__681373AD] DEFAULT ((0)),
