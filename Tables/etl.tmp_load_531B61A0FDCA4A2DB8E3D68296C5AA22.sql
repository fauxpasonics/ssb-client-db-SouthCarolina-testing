CREATE TABLE [etl].[tmp_load_531B61A0FDCA4A2DB8E3D68296C5AA22]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_531B61A0FDCA4A2DB8E3D68296C5AA22_ss] ON [etl].[tmp_load_531B61A0FDCA4A2DB8E3D68296C5AA22] ([SourceSystem], [SSID])
GO
