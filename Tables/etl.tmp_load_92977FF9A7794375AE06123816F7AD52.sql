CREATE TABLE [etl].[tmp_load_92977FF9A7794375AE06123816F7AD52]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_92977FF9A7794375AE06123816F7AD52_ss] ON [etl].[tmp_load_92977FF9A7794375AE06123816F7AD52] ([SourceSystem], [SSID])
GO
