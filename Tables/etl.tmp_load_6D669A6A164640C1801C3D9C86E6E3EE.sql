CREATE TABLE [etl].[tmp_load_6D669A6A164640C1801C3D9C86E6E3EE]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6D669A6A164640C1801C3D9C86E6E3EE_ss] ON [etl].[tmp_load_6D669A6A164640C1801C3D9C86E6E3EE] ([SourceSystem], [SSID])
GO
