CREATE TABLE [etl].[tmp_load_FF58C453AC76490092750744FC0AA26C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FF58C453AC76490092750744FC0AA26C_ss] ON [etl].[tmp_load_FF58C453AC76490092750744FC0AA26C] ([SourceSystem], [SSID])
GO
