CREATE TABLE [segmentation].[SegmentationFlatData9fb5d376-f3a1-4728-bd09-cfcc316920c4]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData9fb5d376-f3a1-4728-bd09-cfcc316920c4] ADD CONSTRAINT [pk_SegmentationFlatData9fb5d376-f3a1-4728-bd09-cfcc316920c4] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData9fb5d376-f3a1-4728-bd09-cfcc316920c4] ON [segmentation].[SegmentationFlatData9fb5d376-f3a1-4728-bd09-cfcc316920c4] ([_rn])
GO
