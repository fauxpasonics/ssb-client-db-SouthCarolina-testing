CREATE TABLE [etl].[tmp_load_CA26E1DBBC774EBB95DC5D863EC6F3BA]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CA26E1DBBC774EBB95DC5D863EC6F3BA_ss] ON [etl].[tmp_load_CA26E1DBBC774EBB95DC5D863EC6F3BA] ([SourceSystem], [SSID])
GO
