CREATE TABLE [etl].[tmp_load_FC1648891B6445ECAF6DC6A319FB4343]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FC1648891B6445ECAF6DC6A319FB4343_ss] ON [etl].[tmp_load_FC1648891B6445ECAF6DC6A319FB4343] ([SourceSystem], [SSID])
GO
