CREATE TABLE [etl].[tmp_load_90D3CB3B478B43FB8A53551023EE85D8]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_90D3CB3B478B43FB8A53551023EE85D8_ss] ON [etl].[tmp_load_90D3CB3B478B43FB8A53551023EE85D8] ([SourceSystem], [SSID])
GO
