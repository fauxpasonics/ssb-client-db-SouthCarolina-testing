CREATE TABLE [etl].[tmp_load_3D318B7E3DD243CABF6B38F528CB5E87]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3D318B7E3DD243CABF6B38F528CB5E87_ss] ON [etl].[tmp_load_3D318B7E3DD243CABF6B38F528CB5E87] ([SourceSystem], [SSID])
GO
