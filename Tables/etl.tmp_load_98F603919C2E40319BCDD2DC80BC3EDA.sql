CREATE TABLE [etl].[tmp_load_98F603919C2E40319BCDD2DC80BC3EDA]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_98F603919C2E40319BCDD2DC80BC3EDA_ss] ON [etl].[tmp_load_98F603919C2E40319BCDD2DC80BC3EDA] ([SourceSystem], [SSID])
GO
