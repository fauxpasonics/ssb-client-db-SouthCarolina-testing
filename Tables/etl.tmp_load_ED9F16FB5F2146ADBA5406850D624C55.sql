CREATE TABLE [etl].[tmp_load_ED9F16FB5F2146ADBA5406850D624C55]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ED9F16FB5F2146ADBA5406850D624C55_ss] ON [etl].[tmp_load_ED9F16FB5F2146ADBA5406850D624C55] ([SourceSystem], [SSID])
GO
