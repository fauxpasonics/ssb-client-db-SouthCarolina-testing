CREATE TABLE [etl].[tmp_load_F22C9D66134B4002B6AB6744C71CEE2C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F22C9D66134B4002B6AB6744C71CEE2C_ss] ON [etl].[tmp_load_F22C9D66134B4002B6AB6744C71CEE2C] ([SourceSystem], [SSID])
GO
