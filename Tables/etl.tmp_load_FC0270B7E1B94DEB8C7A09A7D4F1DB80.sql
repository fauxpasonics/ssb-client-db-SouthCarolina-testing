CREATE TABLE [etl].[tmp_load_FC0270B7E1B94DEB8C7A09A7D4F1DB80]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FC0270B7E1B94DEB8C7A09A7D4F1DB80_ss] ON [etl].[tmp_load_FC0270B7E1B94DEB8C7A09A7D4F1DB80] ([SourceSystem], [SSID])
GO
