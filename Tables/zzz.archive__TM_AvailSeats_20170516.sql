CREATE TABLE [zzz].[archive__TM_AvailSeats_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Creat__7755B73D] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_AvailSeats] ON [zzz].[archive__TM_AvailSeats_20170516] ([event_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_AvailSeats_20170516] ([SourceFileName])
GO
