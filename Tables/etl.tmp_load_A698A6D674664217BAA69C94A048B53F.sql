CREATE TABLE [etl].[tmp_load_A698A6D674664217BAA69C94A048B53F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A698A6D674664217BAA69C94A048B53F_ss] ON [etl].[tmp_load_A698A6D674664217BAA69C94A048B53F] ([SourceSystem], [SSID])
GO
