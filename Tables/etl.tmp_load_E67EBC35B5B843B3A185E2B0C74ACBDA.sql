CREATE TABLE [etl].[tmp_load_E67EBC35B5B843B3A185E2B0C74ACBDA]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E67EBC35B5B843B3A185E2B0C74ACBDA_ss] ON [etl].[tmp_load_E67EBC35B5B843B3A185E2B0C74ACBDA] ([SourceSystem], [SSID])
GO
