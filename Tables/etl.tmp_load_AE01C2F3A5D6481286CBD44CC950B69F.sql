CREATE TABLE [etl].[tmp_load_AE01C2F3A5D6481286CBD44CC950B69F]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_AE01C2F3A5D6481286CBD44CC950B69F_ss] ON [etl].[tmp_load_AE01C2F3A5D6481286CBD44CC950B69F] ([SourceSystem], [SSID])
GO
