CREATE TABLE [etl].[tmp_load_889D619F4FF8408AA5D6169EE35388C5]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_889D619F4FF8408AA5D6169EE35388C5_ss] ON [etl].[tmp_load_889D619F4FF8408AA5D6169EE35388C5] ([SourceSystem], [SSID])
GO
