CREATE TABLE [etl].[tmp_load_F9C3391B55D040C9820DA964CAB652BD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F9C3391B55D040C9820DA964CAB652BD_ss] ON [etl].[tmp_load_F9C3391B55D040C9820DA964CAB652BD] ([SourceSystem], [SSID])
GO
