CREATE TABLE [etl].[tmp_load_6934F3B8EBE74318890F159073509ABB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6934F3B8EBE74318890F159073509ABB_ss] ON [etl].[tmp_load_6934F3B8EBE74318890F159073509ABB] ([SourceSystem], [SSID])
GO
