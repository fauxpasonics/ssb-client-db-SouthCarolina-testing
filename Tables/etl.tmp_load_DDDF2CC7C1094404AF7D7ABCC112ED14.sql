CREATE TABLE [etl].[tmp_load_DDDF2CC7C1094404AF7D7ABCC112ED14]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DDDF2CC7C1094404AF7D7ABCC112ED14_ss] ON [etl].[tmp_load_DDDF2CC7C1094404AF7D7ABCC112ED14] ([SourceSystem], [SSID])
GO
