CREATE TABLE [zzz].[ods__TM_Donation_20170518]
(
...
[stock_cert_num] [datetime] NULL,
[stock_transfer_datetime] [datetime] NULL,
[stock_transfer_date_low_price] [datetime] NULL,
[stock_transfer_date_high_price] [datetime] NULL,
[stock_transfer_date_avg_price] [datetime] NULL,
...
GO
ALTER TABLE [zzz].[ods__TM_Donation_20170518] ADD CONSTRAINT [PK__TM_Donat__3213E83FBC3E601F] PRIMARY KEY CLUSTERED  ([id])
GO
