CREATE TABLE [etl].[tmp_load_EFB8D9B9C1D8460384353057D4719FFC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_EFB8D9B9C1D8460384353057D4719FFC_ss] ON [etl].[tmp_load_EFB8D9B9C1D8460384353057D4719FFC] ([SourceSystem], [SSID])
GO
