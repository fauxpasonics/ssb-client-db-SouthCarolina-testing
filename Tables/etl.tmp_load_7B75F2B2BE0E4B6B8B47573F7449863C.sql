CREATE TABLE [etl].[tmp_load_7B75F2B2BE0E4B6B8B47573F7449863C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7B75F2B2BE0E4B6B8B47573F7449863C_ss] ON [etl].[tmp_load_7B75F2B2BE0E4B6B8B47573F7449863C] ([SourceSystem], [SSID])
GO
