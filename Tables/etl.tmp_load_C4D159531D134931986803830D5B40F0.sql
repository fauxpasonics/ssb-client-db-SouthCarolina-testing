CREATE TABLE [etl].[tmp_load_C4D159531D134931986803830D5B40F0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C4D159531D134931986803830D5B40F0_ss] ON [etl].[tmp_load_C4D159531D134931986803830D5B40F0] ([SourceSystem], [SSID])
GO
