CREATE TABLE [etl].[tmp_load_ABB9F46C32594BF9AC1756EBFCE749FF]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_ABB9F46C32594BF9AC1756EBFCE749FF_ss] ON [etl].[tmp_load_ABB9F46C32594BF9AC1756EBFCE749FF] ([SourceSystem], [SSID])
GO
