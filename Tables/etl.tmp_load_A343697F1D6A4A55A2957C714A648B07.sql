CREATE TABLE [etl].[tmp_load_A343697F1D6A4A55A2957C714A648B07]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A343697F1D6A4A55A2957C714A648B07_ss] ON [etl].[tmp_load_A343697F1D6A4A55A2957C714A648B07] ([SourceSystem], [SSID])
GO
