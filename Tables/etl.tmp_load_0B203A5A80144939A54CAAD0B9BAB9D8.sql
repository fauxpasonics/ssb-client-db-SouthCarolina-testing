CREATE TABLE [etl].[tmp_load_0B203A5A80144939A54CAAD0B9BAB9D8]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0B203A5A80144939A54CAAD0B9BAB9D8_ss] ON [etl].[tmp_load_0B203A5A80144939A54CAAD0B9BAB9D8] ([SourceSystem], [SSID])
GO
