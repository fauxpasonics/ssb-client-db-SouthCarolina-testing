CREATE TABLE [etl].[tmp_load_112454C65F254A89A0B1C783357A5391]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_112454C65F254A89A0B1C783357A5391_ss] ON [etl].[tmp_load_112454C65F254A89A0B1C783357A5391] ([SourceSystem], [SSID])
GO
