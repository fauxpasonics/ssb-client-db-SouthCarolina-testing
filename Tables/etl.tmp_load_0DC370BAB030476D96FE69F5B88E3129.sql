CREATE TABLE [etl].[tmp_load_0DC370BAB030476D96FE69F5B88E3129]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0DC370BAB030476D96FE69F5B88E3129_ss] ON [etl].[tmp_load_0DC370BAB030476D96FE69F5B88E3129] ([SourceSystem], [SSID])
GO
