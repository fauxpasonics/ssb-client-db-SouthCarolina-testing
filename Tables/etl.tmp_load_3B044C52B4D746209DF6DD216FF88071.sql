CREATE TABLE [etl].[tmp_load_3B044C52B4D746209DF6DD216FF88071]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3B044C52B4D746209DF6DD216FF88071_ss] ON [etl].[tmp_load_3B044C52B4D746209DF6DD216FF88071] ([SourceSystem], [SSID])
GO
