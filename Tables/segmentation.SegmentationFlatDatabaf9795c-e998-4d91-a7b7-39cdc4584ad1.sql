CREATE TABLE [segmentation].[SegmentationFlatDatabaf9795c-e998-4d91-a7b7-39cdc4584ad1]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatabaf9795c-e998-4d91-a7b7-39cdc4584ad1] ADD CONSTRAINT [pk_SegmentationFlatDatabaf9795c-e998-4d91-a7b7-39cdc4584ad1] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatabaf9795c-e998-4d91-a7b7-39cdc4584ad1] ON [segmentation].[SegmentationFlatDatabaf9795c-e998-4d91-a7b7-39cdc4584ad1] ([_rn])
GO
