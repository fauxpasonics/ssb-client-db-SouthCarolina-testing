CREATE TABLE [segmentation].[SegmentationFlatData70cd995b-af68-49b4-b878-d0d4721eef2b]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData70cd995b-af68-49b4-b878-d0d4721eef2b] ADD CONSTRAINT [pk_SegmentationFlatData70cd995b-af68-49b4-b878-d0d4721eef2b] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData70cd995b-af68-49b4-b878-d0d4721eef2b] ON [segmentation].[SegmentationFlatData70cd995b-af68-49b4-b878-d0d4721eef2b] ([_rn])
GO
