CREATE TABLE [etl].[tmp_load_39FD3A2EFFD64AD29F677ACBA1EE2C29]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_39FD3A2EFFD64AD29F677ACBA1EE2C29_ss] ON [etl].[tmp_load_39FD3A2EFFD64AD29F677ACBA1EE2C29] ([SourceSystem], [SSID])
GO
