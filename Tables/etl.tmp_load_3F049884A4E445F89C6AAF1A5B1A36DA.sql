CREATE TABLE [etl].[tmp_load_3F049884A4E445F89C6AAF1A5B1A36DA]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3F049884A4E445F89C6AAF1A5B1A36DA_ss] ON [etl].[tmp_load_3F049884A4E445F89C6AAF1A5B1A36DA] ([SourceSystem], [SSID])
GO
