CREATE TABLE [etl].[tmp_load_FF966711992A452B8D3EE5BAFC527CC6]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FF966711992A452B8D3EE5BAFC527CC6_ss] ON [etl].[tmp_load_FF966711992A452B8D3EE5BAFC527CC6] ([SourceSystem], [SSID])
GO
