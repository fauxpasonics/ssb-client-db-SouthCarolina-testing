CREATE TABLE [etl].[tmp_load_F59C90E671874224AC690655719643B0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F59C90E671874224AC690655719643B0_ss] ON [etl].[tmp_load_F59C90E671874224AC690655719643B0] ([SourceSystem], [SSID])
GO
