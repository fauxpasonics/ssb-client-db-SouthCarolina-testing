CREATE TABLE [etl].[tmp_load_08A1630B9E5B4D2C9A3BF47E4E2B6750]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_08A1630B9E5B4D2C9A3BF47E4E2B6750_ss] ON [etl].[tmp_load_08A1630B9E5B4D2C9A3BF47E4E2B6750] ([SourceSystem], [SSID])
GO
