CREATE TABLE [etl].[tmp_load_8436C64A413A4F00A2DF82C6B5A45211]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8436C64A413A4F00A2DF82C6B5A45211_ss] ON [etl].[tmp_load_8436C64A413A4F00A2DF82C6B5A45211] ([SourceSystem], [SSID])
GO
