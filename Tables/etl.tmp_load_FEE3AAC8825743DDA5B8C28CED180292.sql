CREATE TABLE [etl].[tmp_load_FEE3AAC8825743DDA5B8C28CED180292]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FEE3AAC8825743DDA5B8C28CED180292_ss] ON [etl].[tmp_load_FEE3AAC8825743DDA5B8C28CED180292] ([SourceSystem], [SSID])
GO
