CREATE TABLE [etl].[tmp_load_C37665333C1F4C2EA33F7C0AACBD6A55]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C37665333C1F4C2EA33F7C0AACBD6A55_ss] ON [etl].[tmp_load_C37665333C1F4C2EA33F7C0AACBD6A55] ([SourceSystem], [SSID])
GO
