CREATE TABLE [zzz].[ods__TM_RetailNonTicket_20170516]
(
...
GO
ALTER TABLE [zzz].[ods__TM_RetailNonTicket_20170516] ADD CONSTRAINT [PK__TM_Retai__3213E83F912FFE54] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_HashKey] ON [zzz].[ods__TM_RetailNonTicket_20170516] ([HashKey])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[ods__TM_RetailNonTicket_20170516] ([SourceFileName])
GO
