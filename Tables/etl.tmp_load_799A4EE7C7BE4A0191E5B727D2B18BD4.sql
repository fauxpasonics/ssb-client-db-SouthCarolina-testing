CREATE TABLE [etl].[tmp_load_799A4EE7C7BE4A0191E5B727D2B18BD4]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_799A4EE7C7BE4A0191E5B727D2B18BD4_ss] ON [etl].[tmp_load_799A4EE7C7BE4A0191E5B727D2B18BD4] ([SourceSystem], [SSID])
GO
