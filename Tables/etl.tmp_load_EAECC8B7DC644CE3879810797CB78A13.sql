CREATE TABLE [etl].[tmp_load_EAECC8B7DC644CE3879810797CB78A13]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_EAECC8B7DC644CE3879810797CB78A13_ss] ON [etl].[tmp_load_EAECC8B7DC644CE3879810797CB78A13] ([SourceSystem], [SSID])
GO
