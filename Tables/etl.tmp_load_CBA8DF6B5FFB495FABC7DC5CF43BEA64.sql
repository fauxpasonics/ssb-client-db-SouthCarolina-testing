CREATE TABLE [etl].[tmp_load_CBA8DF6B5FFB495FABC7DC5CF43BEA64]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CBA8DF6B5FFB495FABC7DC5CF43BEA64_ss] ON [etl].[tmp_load_CBA8DF6B5FFB495FABC7DC5CF43BEA64] ([SourceSystem], [SSID])
GO
