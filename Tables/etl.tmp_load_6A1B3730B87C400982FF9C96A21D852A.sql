CREATE TABLE [etl].[tmp_load_6A1B3730B87C400982FF9C96A21D852A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_6A1B3730B87C400982FF9C96A21D852A_ss] ON [etl].[tmp_load_6A1B3730B87C400982FF9C96A21D852A] ([SourceSystem], [SSID])
GO
