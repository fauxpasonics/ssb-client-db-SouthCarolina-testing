CREATE TABLE [etl].[tmp_load_2C24D7F654BD4F1C99F926C8E22CA75C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2C24D7F654BD4F1C99F926C8E22CA75C_ss] ON [etl].[tmp_load_2C24D7F654BD4F1C99F926C8E22CA75C] ([SourceSystem], [SSID])
GO
