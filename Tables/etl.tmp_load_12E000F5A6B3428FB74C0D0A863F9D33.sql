CREATE TABLE [etl].[tmp_load_12E000F5A6B3428FB74C0D0A863F9D33]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_12E000F5A6B3428FB74C0D0A863F9D33_ss] ON [etl].[tmp_load_12E000F5A6B3428FB74C0D0A863F9D33] ([SourceSystem], [SSID])
GO
