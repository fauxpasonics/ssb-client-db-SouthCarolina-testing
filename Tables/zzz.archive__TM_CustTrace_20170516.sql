CREATE TABLE [zzz].[archive__TM_CustTrace_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_CustTr__Creat__1C873BEC] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_CustTrace_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_CustTrace] ON [zzz].[archive__TM_CustTrace_20170516] ([seq_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_CustTrace_20170516] ([SourceFileName])
GO
