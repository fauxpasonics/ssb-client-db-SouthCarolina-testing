CREATE TABLE [etl].[tmp_load_9F3D1DCFA9FA43E18C1F79F359C19016]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9F3D1DCFA9FA43E18C1F79F359C19016_ss] ON [etl].[tmp_load_9F3D1DCFA9FA43E18C1F79F359C19016] ([SourceSystem], [SSID])
GO
