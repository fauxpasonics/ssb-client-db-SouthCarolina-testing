CREATE TABLE [etl].[tmp_load_72E1EB55F82C4D029816A1CDB2FE1223]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_72E1EB55F82C4D029816A1CDB2FE1223_ss] ON [etl].[tmp_load_72E1EB55F82C4D029816A1CDB2FE1223] ([SourceSystem], [SSID])
GO
