CREATE TABLE [etl].[tmp_load_432C1C748B7F4D549228670147D8BC42]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_432C1C748B7F4D549228670147D8BC42_ss] ON [etl].[tmp_load_432C1C748B7F4D549228670147D8BC42] ([SourceSystem], [SSID])
GO
