CREATE TABLE [etl].[tmp_load_C88554C8EF83416C88A880246A929C52]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C88554C8EF83416C88A880246A929C52_ss] ON [etl].[tmp_load_C88554C8EF83416C88A880246A929C52] ([SourceSystem], [SSID])
GO
