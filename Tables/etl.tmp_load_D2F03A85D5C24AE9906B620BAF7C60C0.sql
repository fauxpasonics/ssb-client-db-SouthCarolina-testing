CREATE TABLE [etl].[tmp_load_D2F03A85D5C24AE9906B620BAF7C60C0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D2F03A85D5C24AE9906B620BAF7C60C0_ss] ON [etl].[tmp_load_D2F03A85D5C24AE9906B620BAF7C60C0] ([SourceSystem], [SSID])
GO
