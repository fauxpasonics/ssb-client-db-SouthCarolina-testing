CREATE TABLE [etl].[tmp_load_D3141AF35A1B46B5AA7ECBDCBED8F536]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D3141AF35A1B46B5AA7ECBDCBED8F536_ss] ON [etl].[tmp_load_D3141AF35A1B46B5AA7ECBDCBED8F536] ([SourceSystem], [SSID])
GO
