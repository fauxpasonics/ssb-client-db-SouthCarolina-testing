CREATE TABLE [zzz].[ods__TM_AttendApi_20170516]
(
...
GO
ALTER TABLE [zzz].[ods__TM_AttendApi_20170516] ADD CONSTRAINT [PK__TM_Atten__C4EA2445D782FC15] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
CREATE NONCLUSTERED INDEX [IDX_LoadKey] ON [zzz].[ods__TM_AttendApi_20170516] ([event_id], [section_id], [row_id], [seat_num])
GO
CREATE NONCLUSTERED INDEX [IDX_result_code] ON [zzz].[ods__TM_AttendApi_20170516] ([result_code])
GO
