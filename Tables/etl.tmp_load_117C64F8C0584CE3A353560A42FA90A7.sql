CREATE TABLE [etl].[tmp_load_117C64F8C0584CE3A353560A42FA90A7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_117C64F8C0584CE3A353560A42FA90A7_ss] ON [etl].[tmp_load_117C64F8C0584CE3A353560A42FA90A7] ([SourceSystem], [SSID])
GO
