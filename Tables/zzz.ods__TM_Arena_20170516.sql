CREATE TABLE [zzz].[ods__TM_Arena_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Insert__182C9B23] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Update__1920BF5C] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_Arena_20170516] ADD CONSTRAINT [PK__TM_Arena__3213E83F51C7B4C0] PRIMARY KEY CLUSTERED  ([id])
GO
