CREATE TABLE [etl].[tmp_load_474939378F4747DB8255421122563593]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_474939378F4747DB8255421122563593_ss] ON [etl].[tmp_load_474939378F4747DB8255421122563593] ([SourceSystem], [SSID])
GO
