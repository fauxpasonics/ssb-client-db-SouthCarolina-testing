CREATE TABLE [zzz].[archive__TM_Note_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Note__Created__0697FACD] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Note_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Note] ON [zzz].[archive__TM_Note_20170516] ([note_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Note_20170516] ([SourceFileName])
GO
