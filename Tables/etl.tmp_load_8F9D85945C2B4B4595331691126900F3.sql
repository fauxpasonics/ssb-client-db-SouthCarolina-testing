CREATE TABLE [etl].[tmp_load_8F9D85945C2B4B4595331691126900F3]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8F9D85945C2B4B4595331691126900F3_ss] ON [etl].[tmp_load_8F9D85945C2B4B4595331691126900F3] ([SourceSystem], [SSID])
GO
