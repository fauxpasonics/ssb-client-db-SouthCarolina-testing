CREATE TABLE [etl].[tmp_load_463C0A4895104E0EBE0D63A32DF85B14]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_463C0A4895104E0EBE0D63A32DF85B14_ss] ON [etl].[tmp_load_463C0A4895104E0EBE0D63A32DF85B14] ([SourceSystem], [SSID])
GO
