CREATE TABLE [etl].[tmp_load_2C86B2D6CB9449879FD08754AFDB316E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2C86B2D6CB9449879FD08754AFDB316E_ss] ON [etl].[tmp_load_2C86B2D6CB9449879FD08754AFDB316E] ([SourceSystem], [SSID])
GO
