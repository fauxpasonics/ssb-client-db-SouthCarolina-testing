CREATE TABLE [etl].[tmp_load_1B5D0A25528F46EBA0D8FE2E405278A1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1B5D0A25528F46EBA0D8FE2E405278A1_ss] ON [etl].[tmp_load_1B5D0A25528F46EBA0D8FE2E405278A1] ([SourceSystem], [SSID])
GO
