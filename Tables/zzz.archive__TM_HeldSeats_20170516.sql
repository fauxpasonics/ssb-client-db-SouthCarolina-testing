CREATE TABLE [zzz].[archive__TM_HeldSeats_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Creat__00DF2177] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_HeldSeats_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_HeldSeats] ON [zzz].[archive__TM_HeldSeats_20170516] ([event_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_HeldSeats_20170516] ([SourceFileName])
GO
