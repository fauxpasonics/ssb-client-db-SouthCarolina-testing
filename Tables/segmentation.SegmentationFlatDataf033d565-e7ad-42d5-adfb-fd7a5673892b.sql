CREATE TABLE [segmentation].[SegmentationFlatDataf033d565-e7ad-42d5-adfb-fd7a5673892b]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataf033d565-e7ad-42d5-adfb-fd7a5673892b] ADD CONSTRAINT [pk_SegmentationFlatDataf033d565-e7ad-42d5-adfb-fd7a5673892b] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataf033d565-e7ad-42d5-adfb-fd7a5673892b] ON [segmentation].[SegmentationFlatDataf033d565-e7ad-42d5-adfb-fd7a5673892b] ([_rn])
GO
