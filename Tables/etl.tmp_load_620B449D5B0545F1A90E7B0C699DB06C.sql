CREATE TABLE [etl].[tmp_load_620B449D5B0545F1A90E7B0C699DB06C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_620B449D5B0545F1A90E7B0C699DB06C_ss] ON [etl].[tmp_load_620B449D5B0545F1A90E7B0C699DB06C] ([SourceSystem], [SSID])
GO
