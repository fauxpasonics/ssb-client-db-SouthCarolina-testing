CREATE TABLE [zzz].[archive__TM_PromoCode_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Creat__0C50D423] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_PromoCode_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_PromoCode] ON [zzz].[archive__TM_PromoCode_20170516] ([promo_code_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_PromoCode_20170516] ([SourceFileName])
GO
