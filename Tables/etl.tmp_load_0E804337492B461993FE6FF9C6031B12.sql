CREATE TABLE [etl].[tmp_load_0E804337492B461993FE6FF9C6031B12]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0E804337492B461993FE6FF9C6031B12_ss] ON [etl].[tmp_load_0E804337492B461993FE6FF9C6031B12] ([SourceSystem], [SSID])
GO
