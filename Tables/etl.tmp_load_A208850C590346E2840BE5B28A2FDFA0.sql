CREATE TABLE [etl].[tmp_load_A208850C590346E2840BE5B28A2FDFA0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A208850C590346E2840BE5B28A2FDFA0_ss] ON [etl].[tmp_load_A208850C590346E2840BE5B28A2FDFA0] ([SourceSystem], [SSID])
GO
