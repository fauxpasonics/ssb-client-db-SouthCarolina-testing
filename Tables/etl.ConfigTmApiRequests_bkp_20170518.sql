CREATE TABLE [etl].[ConfigTmApiRequests_bkp_20170518]
(
...
GO
ALTER TABLE [etl].[ConfigTmApiRequests_bkp_20170518] ADD CONSTRAINT [PK__ConfigTm__3214EC07423381B9] PRIMARY KEY CLUSTERED  ([Id])
GO
