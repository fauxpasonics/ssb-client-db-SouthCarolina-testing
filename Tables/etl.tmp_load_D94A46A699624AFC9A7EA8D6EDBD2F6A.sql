CREATE TABLE [etl].[tmp_load_D94A46A699624AFC9A7EA8D6EDBD2F6A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D94A46A699624AFC9A7EA8D6EDBD2F6A_ss] ON [etl].[tmp_load_D94A46A699624AFC9A7EA8D6EDBD2F6A] ([SourceSystem], [SSID])
GO
