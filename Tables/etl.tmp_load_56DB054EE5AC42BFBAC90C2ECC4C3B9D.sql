CREATE TABLE [etl].[tmp_load_56DB054EE5AC42BFBAC90C2ECC4C3B9D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_56DB054EE5AC42BFBAC90C2ECC4C3B9D_ss] ON [etl].[tmp_load_56DB054EE5AC42BFBAC90C2ECC4C3B9D] ([SourceSystem], [SSID])
GO
