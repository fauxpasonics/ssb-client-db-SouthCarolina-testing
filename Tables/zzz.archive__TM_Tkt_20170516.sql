CREATE TABLE [zzz].[archive__TM_Tkt_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__CreatedD__15DA3E5D] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Tkt_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Tkt] ON [zzz].[archive__TM_Tkt_20170516] ([event_name])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Tkt_20170516] ([SourceFileName])
GO
