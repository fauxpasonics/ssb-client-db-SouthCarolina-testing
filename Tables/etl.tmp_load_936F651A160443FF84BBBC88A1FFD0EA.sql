CREATE TABLE [etl].[tmp_load_936F651A160443FF84BBBC88A1FFD0EA]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_936F651A160443FF84BBBC88A1FFD0EA_ss] ON [etl].[tmp_load_936F651A160443FF84BBBC88A1FFD0EA] ([SourceSystem], [SSID])
GO
