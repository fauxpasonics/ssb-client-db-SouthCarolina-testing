CREATE TABLE [zzz].[archive__TM_Journal_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Creat__02C769E9] DEFAULT (getdate()),
...
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Journal] ON [zzz].[archive__TM_Journal_20170516] ([acct_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Journal_20170516] ([SourceFileName])
GO
