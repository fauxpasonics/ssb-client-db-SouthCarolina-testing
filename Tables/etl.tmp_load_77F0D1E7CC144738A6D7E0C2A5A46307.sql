CREATE TABLE [etl].[tmp_load_77F0D1E7CC144738A6D7E0C2A5A46307]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_77F0D1E7CC144738A6D7E0C2A5A46307_ss] ON [etl].[tmp_load_77F0D1E7CC144738A6D7E0C2A5A46307] ([SourceSystem], [SSID])
GO
