CREATE TABLE [etl].[tmp_load_F73573056DD242B49D628C5C63B29BD0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F73573056DD242B49D628C5C63B29BD0_ss] ON [etl].[tmp_load_F73573056DD242B49D628C5C63B29BD0] ([SourceSystem], [SSID])
GO
