CREATE TABLE [etl].[tmp_load_4C84AF3773CA4DF08B8243268C37B2CC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4C84AF3773CA4DF08B8243268C37B2CC_ss] ON [etl].[tmp_load_4C84AF3773CA4DF08B8243268C37B2CC] ([SourceSystem], [SSID])
GO
