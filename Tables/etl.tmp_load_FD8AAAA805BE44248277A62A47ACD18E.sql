CREATE TABLE [etl].[tmp_load_FD8AAAA805BE44248277A62A47ACD18E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FD8AAAA805BE44248277A62A47ACD18E_ss] ON [etl].[tmp_load_FD8AAAA805BE44248277A62A47ACD18E] ([SourceSystem], [SSID])
GO
