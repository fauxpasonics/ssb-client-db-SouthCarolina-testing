CREATE TABLE [zzz].[archive__TM_Ledger_20170516]
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Ledger_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Ledger] ON [zzz].[archive__TM_Ledger_20170516] ([ledger_id])
GO
