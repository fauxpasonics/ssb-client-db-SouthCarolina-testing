CREATE TABLE [etl].[tmp_load_BCF3CEA923DF4F6C93B7A28FC357F625]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_BCF3CEA923DF4F6C93B7A28FC357F625_ss] ON [etl].[tmp_load_BCF3CEA923DF4F6C93B7A28FC357F625] ([SourceSystem], [SSID])
GO
