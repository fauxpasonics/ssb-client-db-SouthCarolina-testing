CREATE TABLE [etl].[tmp_load_481A2E988CD548779499339C1D43033A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_481A2E988CD548779499339C1D43033A_ss] ON [etl].[tmp_load_481A2E988CD548779499339C1D43033A] ([SourceSystem], [SSID])
GO
