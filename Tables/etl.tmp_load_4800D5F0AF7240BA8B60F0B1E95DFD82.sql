CREATE TABLE [etl].[tmp_load_4800D5F0AF7240BA8B60F0B1E95DFD82]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4800D5F0AF7240BA8B60F0B1E95DFD82_ss] ON [etl].[tmp_load_4800D5F0AF7240BA8B60F0B1E95DFD82] ([SourceSystem], [SSID])
GO
