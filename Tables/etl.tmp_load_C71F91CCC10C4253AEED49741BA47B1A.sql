CREATE TABLE [etl].[tmp_load_C71F91CCC10C4253AEED49741BA47B1A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C71F91CCC10C4253AEED49741BA47B1A_ss] ON [etl].[tmp_load_C71F91CCC10C4253AEED49741BA47B1A] ([SourceSystem], [SSID])
GO
