CREATE TABLE [etl].[tmp_load_A586012B5C8F4F9DB810684E550C0F8E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A586012B5C8F4F9DB810684E550C0F8E_ss] ON [etl].[tmp_load_A586012B5C8F4F9DB810684E550C0F8E] ([SourceSystem], [SSID])
GO
