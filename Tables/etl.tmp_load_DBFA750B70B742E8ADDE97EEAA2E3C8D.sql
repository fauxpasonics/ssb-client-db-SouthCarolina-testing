CREATE TABLE [etl].[tmp_load_DBFA750B70B742E8ADDE97EEAA2E3C8D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DBFA750B70B742E8ADDE97EEAA2E3C8D_ss] ON [etl].[tmp_load_DBFA750B70B742E8ADDE97EEAA2E3C8D] ([SourceSystem], [SSID])
GO
