CREATE TABLE [etl].[tmp_load_33296FE316754A108FCC945C88BD9FBC]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_33296FE316754A108FCC945C88BD9FBC_ss] ON [etl].[tmp_load_33296FE316754A108FCC945C88BD9FBC] ([SourceSystem], [SSID])
GO
