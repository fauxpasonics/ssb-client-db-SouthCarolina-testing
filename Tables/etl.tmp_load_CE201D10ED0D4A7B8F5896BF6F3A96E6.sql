CREATE TABLE [etl].[tmp_load_CE201D10ED0D4A7B8F5896BF6F3A96E6]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CE201D10ED0D4A7B8F5896BF6F3A96E6_ss] ON [etl].[tmp_load_CE201D10ED0D4A7B8F5896BF6F3A96E6] ([SourceSystem], [SSID])
GO
