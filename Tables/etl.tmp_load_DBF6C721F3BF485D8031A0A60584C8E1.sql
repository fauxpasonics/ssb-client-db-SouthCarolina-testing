CREATE TABLE [etl].[tmp_load_DBF6C721F3BF485D8031A0A60584C8E1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DBF6C721F3BF485D8031A0A60584C8E1_ss] ON [etl].[tmp_load_DBF6C721F3BF485D8031A0A60584C8E1] ([SourceSystem], [SSID])
GO
