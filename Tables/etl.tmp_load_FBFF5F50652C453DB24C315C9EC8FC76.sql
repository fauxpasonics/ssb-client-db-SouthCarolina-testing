CREATE TABLE [etl].[tmp_load_FBFF5F50652C453DB24C315C9EC8FC76]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FBFF5F50652C453DB24C315C9EC8FC76_ss] ON [etl].[tmp_load_FBFF5F50652C453DB24C315C9EC8FC76] ([SourceSystem], [SSID])
GO
