CREATE TABLE [etl].[tmp_load_9DCBEC8B0A404F229BFBCCB42C012EAD]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9DCBEC8B0A404F229BFBCCB42C012EAD_ss] ON [etl].[tmp_load_9DCBEC8B0A404F229BFBCCB42C012EAD] ([SourceSystem], [SSID])
GO
