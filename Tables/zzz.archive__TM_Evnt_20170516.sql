CREATE TABLE [zzz].[archive__TM_Evnt_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__Created__7EF6D905] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Evnt_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Evnt] ON [zzz].[archive__TM_Evnt_20170516] ([event_name])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Evnt_20170516] ([SourceFileName])
GO
