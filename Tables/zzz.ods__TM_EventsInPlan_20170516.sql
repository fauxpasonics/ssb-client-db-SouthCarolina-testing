CREATE TABLE [zzz].[ods__TM_EventsInPlan_20170516]
(
...
[season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Inser__38996AB5] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Updat__398D8EEE] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_EventsInPlan_20170516] ADD CONSTRAINT [PK__TM_Event__3213E83F8FFDB49B] PRIMARY KEY CLUSTERED  ([id])
GO
