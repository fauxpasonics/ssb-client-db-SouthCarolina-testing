...
GO
CREATE NONCLUSTERED INDEX [FactTicketSales_CustomerId] ON [dbo].[FactTicketSales_V2] ([DimTicketCustomerId]) INCLUDE ([DimDateId], [DimEventId], [DimItemId], [DimPriceCodeId], [DimRepId], [DimSeasonId], [DimSeatId_Start], [DimTicketTypeId], [FullPrice], [OwedAmount], [PaidAmount], [QtySeat])
GO
