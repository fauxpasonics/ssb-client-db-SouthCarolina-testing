CREATE TABLE [etl].[tmp_load_FDDAF209EC2A4BF4A4FC61FA3C9A367A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_FDDAF209EC2A4BF4A4FC61FA3C9A367A_ss] ON [etl].[tmp_load_FDDAF209EC2A4BF4A4FC61FA3C9A367A] ([SourceSystem], [SSID])
GO
