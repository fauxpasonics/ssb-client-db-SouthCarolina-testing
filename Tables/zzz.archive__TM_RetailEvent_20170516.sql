CREATE TABLE [zzz].[archive__TM_RetailEvent_20170516]
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_RetailEvent_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_RetailEvent] ON [zzz].[archive__TM_RetailEvent_20170516] ([retail_event_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_RetailEvent_20170516] ([SourceFileName])
GO
