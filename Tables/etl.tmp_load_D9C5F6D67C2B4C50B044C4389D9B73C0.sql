CREATE TABLE [etl].[tmp_load_D9C5F6D67C2B4C50B044C4389D9B73C0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D9C5F6D67C2B4C50B044C4389D9B73C0_ss] ON [etl].[tmp_load_D9C5F6D67C2B4C50B044C4389D9B73C0] ([SourceSystem], [SSID])
GO
