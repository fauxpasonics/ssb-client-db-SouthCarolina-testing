CREATE TABLE [etl].[tmp_load_961C85B4490741C58A476252B89E5337]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_961C85B4490741C58A476252B89E5337_ss] ON [etl].[tmp_load_961C85B4490741C58A476252B89E5337] ([SourceSystem], [SSID])
GO
