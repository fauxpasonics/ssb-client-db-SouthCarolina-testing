CREATE TABLE [zzz].[archive__TM_PriceCode_20170516]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Creat__0A688BB1] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_PriceCode_20170516] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_PriceCode] ON [zzz].[archive__TM_PriceCode_20170516] ([season_id])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_PriceCode_20170516] ([SourceFileName])
GO
