CREATE TABLE [etl].[tmp_load_E9BB5A20834C438B980B8F41822C45D7]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E9BB5A20834C438B980B8F41822C45D7_ss] ON [etl].[tmp_load_E9BB5A20834C438B980B8F41822C45D7] ([SourceSystem], [SSID])
GO
