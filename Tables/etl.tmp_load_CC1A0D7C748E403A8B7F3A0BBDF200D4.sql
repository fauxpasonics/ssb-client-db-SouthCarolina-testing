CREATE TABLE [etl].[tmp_load_CC1A0D7C748E403A8B7F3A0BBDF200D4]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CC1A0D7C748E403A8B7F3A0BBDF200D4_ss] ON [etl].[tmp_load_CC1A0D7C748E403A8B7F3A0BBDF200D4] ([SourceSystem], [SSID])
GO
