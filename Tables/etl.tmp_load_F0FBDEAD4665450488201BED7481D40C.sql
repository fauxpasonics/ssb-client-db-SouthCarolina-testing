CREATE TABLE [etl].[tmp_load_F0FBDEAD4665450488201BED7481D40C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_F0FBDEAD4665450488201BED7481D40C_ss] ON [etl].[tmp_load_F0FBDEAD4665450488201BED7481D40C] ([SourceSystem], [SSID])
GO
