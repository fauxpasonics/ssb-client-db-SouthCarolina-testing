CREATE TABLE [etl].[tmp_load_B6CD2EFA99C94C3A8B9FC6DDD1D95F3C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B6CD2EFA99C94C3A8B9FC6DDD1D95F3C_ss] ON [etl].[tmp_load_B6CD2EFA99C94C3A8B9FC6DDD1D95F3C] ([SourceSystem], [SSID])
GO
