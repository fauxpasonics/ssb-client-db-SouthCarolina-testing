CREATE TABLE [etl].[tmp_load_D888B5B9419C4F9098396FB9088DDC29]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D888B5B9419C4F9098396FB9088DDC29_ss] ON [etl].[tmp_load_D888B5B9419C4F9098396FB9088DDC29] ([SourceSystem], [SSID])
GO
