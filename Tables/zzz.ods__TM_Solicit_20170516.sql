CREATE TABLE [zzz].[ods__TM_Solicit_20170516]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__05D8E0BE] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__06CD04F7] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_Solicit_20170516] ADD CONSTRAINT [PK__TM_Solic__3213E83F62395BC4] PRIMARY KEY CLUSTERED  ([id])
GO
