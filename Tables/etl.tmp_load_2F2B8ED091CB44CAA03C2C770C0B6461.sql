CREATE TABLE [etl].[tmp_load_2F2B8ED091CB44CAA03C2C770C0B6461]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2F2B8ED091CB44CAA03C2C770C0B6461_ss] ON [etl].[tmp_load_2F2B8ED091CB44CAA03C2C770C0B6461] ([SourceSystem], [SSID])
GO
