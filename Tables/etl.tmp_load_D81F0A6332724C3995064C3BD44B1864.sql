CREATE TABLE [etl].[tmp_load_D81F0A6332724C3995064C3BD44B1864]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D81F0A6332724C3995064C3BD44B1864_ss] ON [etl].[tmp_load_D81F0A6332724C3995064C3BD44B1864] ([SourceSystem], [SSID])
GO
